...
def parse_args():
    ...
    parser.add_argument("--partition", default="learnai4rl", type=str, help="Partition where to submit")
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path(f"/fsx/{user}").is_dir():
        p = Path(f"/fsx/{user}/checkpoint/convnext")
